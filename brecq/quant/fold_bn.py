...
def _fold_bn(conv_module, bn_module):
    ...
    if isinstance(bn_module, FrozenBatchNorm2d) or bn_module.affine:
...
def is_bn(m):
    return isinstance(m, nn.BatchNorm2d) or isinstance(m, nn.BatchNorm1d) or isinstance(m, FrozenBatchNorm2d)
